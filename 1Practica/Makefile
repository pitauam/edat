...
runv:
	...
	valgrind --leak-check=full --show-leak-kinds=all ./p1_e1
	@echo ">>>>>>Running p1_e2 with valgrind"
	valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes ./p1_e2 
	@echo ">>>>>>Running p1_e3 with valgrind"
	valgrind --leak-check=full --show-leak-kinds=all ./p1_e3 radio1.txt
